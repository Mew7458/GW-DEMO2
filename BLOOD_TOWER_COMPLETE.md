...
## Finish Patch Verification

The following advanced features from the original spec were completed/verified:

- **Assassin Stealth** (hiddenGift): implemented/verified.
- **Blood Pollution** (Elite passive): implemented with persistent 2-turn blood-stain tiles.
- **Divine Instruction Transmitter** (Boss passive): implemented as the 35% 邪教目标 trigger.
