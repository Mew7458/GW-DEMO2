...
**Finish patch:** Blood pollution spread is now implemented: attacks from the elite create 2-turn blood-stain tiles that damage player units and add bleed.
...
The following advanced features were completed/verified in the finish patch:

1. **Assassin Stealth** (hiddenGift passive): implemented/verified. Assassins start invisible, lose stealth when dealing/taking damage, and re-enter stealth after 3 quiet turns.
2. **Blood Pollution** (Elite passive): implemented. Elite attacks create 2-turn blood-stain tiles; player units standing on them take 5 HP + 5 SP and gain 1 bleed.
3. **Divine Instruction Transmitter** (Boss passive): implemented. Boss B attacks have a 35% chance to add 1 stack of 邪教目标.
